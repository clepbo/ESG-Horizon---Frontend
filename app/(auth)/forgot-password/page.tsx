...
export default function ForgotPasswordPage() {
  ...
  const onSubmit: SubmitHandler<FormFields> = async (data) => {
    ...
    try {
      ...
      toast.success("If that email is registered, we have sent a password reset code.");
      reset();
    ...
    <div className="relative min-h-screen flex items-center justify-center px-4 bg-white overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md space-y-6">
        ...
        <div className="bg-white rounded-lg border border-neutral-200 p-8 shadow-sm backdrop-blur-md">
          <h2 className="text-2xl font-semibold text-neutral-900 mb-2">Forgot your password</h2>
          <p className="text-sm text-neutral-600 mb-6">Enter your email to reset your password</p>
