...
export function SuccessModal({ isOpen, onClose, onContinue }: SuccessModalProps) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-primary text-white border-0 shadow-2xl">
        ...
        <div className="flex justify-center pt-4">
          <CustomButton
            onClick={onContinue}
            className="px-8 py-2 bg-white text-primary hover:bg-gray-100 transition-colors"
          >
            Continue
          </CustomButton>
        </div>
