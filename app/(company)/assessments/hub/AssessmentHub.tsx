      ...
      >
        ...
        <div className="space-y-1 mb-6">
          ...
          <p className="text-base text-muted-foreground">
            Start a new assessment to capture your company&apos;s ESG and GHG
            data, track performance, and generate complaince-ready reports.
          </p>
        </div>
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className="mt-3 w-full hover:cursor-pointer border border-slate-300 transition-colors focus:ring-2 focus:ring-green-500">
                    <SelectValue
                      placeholder={
                        isLoading ? "Loading..." : "Choose a subsidiary"
                      }
                    />
                  </SelectTrigger>
                  <SelectContent>
