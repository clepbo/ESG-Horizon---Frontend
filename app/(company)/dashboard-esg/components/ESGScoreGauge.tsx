...
const GRADE_MAP: Record<string, GradeInfo> = {
  "A+": {
    ...
    fill: "#059669", label: "Industry Leader",
    description: "Exceptional ESG performance. Industry-leading practices across all pillars with minimal risk exposure.",
    range: "95 – 100",
  },
  A: {
    bg: "bg-emerald-50", text: "text-emerald-700", border: "border-emerald-200",
    fill: "#10B981", label: "Excellent",
    description: "Excellent ESG performance with robust management systems and low material risk across all pillars.",
    range: "85 – 94",
  },
  "B+": {
    bg: "bg-teal-50", text: "text-teal-700", border: "border-teal-200",
    fill: "#14B8A6", label: "Strong",
    description: "Strong ESG performance. Key risks are well managed with clear improvement trajectories.",
    range: "75 – 84",
  },
  B: {
    bg: "bg-blue-50", text: "text-blue-700", border: "border-blue-200",
    fill: "#3B82F6", label: "Average / Compliant",
    description: "Average ESG performance. Meets baseline compliance requirements; some material risks need further attention.",
    range: "65 – 74",
  },
  C: {
    bg: "bg-amber-50", text: "text-amber-700", border: "border-amber-200",
    fill: "#F59E0B", label: "Weak / At Risk",
    description: "Weak ESG performance. Significant gaps in risk management that could impact operations and stakeholders.",
    range: "50 – 64",
  },
  D: {
    bg: "bg-red-50", text: "text-red-700", border: "border-red-200",
    fill: "#EF4444", label: "Critical Failure",
    description: "Critical ESG deficiencies. Immediate action needed across multiple pillars to address material risks.",
    range: "0 – 49",
  },
};
    ...
    <div className="rounded-2xl bg-white p-6 flex flex-col items-center justify-center h-full min-h-[180px] shadow-sm cursor-default relative">
      ...
      <div className="flex items-center gap-2 self-start w-full">
        ...
        <div className="ml-auto flex items-center gap-2">
          {gradeInfo && grade && (
            <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-sm font-bold border ${gradeInfo.bg} ${gradeInfo.text} ${gradeInfo.border}`}>
      ...
      {gradeInfo && (
        <p className={`mt-1 text-xs font-semibold ${gradeInfo.text}`}>
          {gradeInfo.label}
        </p>
      )}
      ...
      {open && createPortal(
        <>
          ...
          >
            ...
            {gradeInfo && grade && (
              <div className={`mx-4 mt-3 p-3 rounded-lg border ${gradeInfo.bg} ${gradeInfo.border}`}>
