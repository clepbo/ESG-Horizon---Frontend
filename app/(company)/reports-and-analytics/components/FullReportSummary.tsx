...
export default function FullReportSummary() {
    const emissionSources: EmissionSource[] = [
        { id: 1, name: "Diesel Generators", location: "Port Harcourt Refinery", value: 4420, scope: "Scope 1" },
            ...
            <Card>
                ...
                <CardContent className="text-center space-y-4">
                    ...
                    <div className="text-sm space-y-1">
                        <p>2016 Baseline: <span className="font-medium">66,000 tCO₂e</span></p>
                        <p>2025 Actual: <span className="font-medium">54,200 tCO₂e</span></p>
                        <p>2030 Target: <span className="font-medium">52,800 tCO₂e</span></p>
                    </div>
                </CardContent>
            </Card>
                        ...
                        {emissionSources.map((source) => (
                            ...
                            >
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-xs text-muted-foreground border rounded-3xl px-1 whitespace-nowrap">{source.scope}</p>
                                </div>
                            </li>
                        ))}
                    </ul>
