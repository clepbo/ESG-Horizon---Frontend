...
export default function ReportPage() {
  ...
  const debugDates = () => {
    ...
    reportData.forEach(report => {
      ...
      console.log(`${report.subsidiary}: ${report.startMonth} ${report.startYear} -> ${start}, ${report.endMonth} ${report.endYear} -> ${end}`);
    });
  };
  ...
  return (
    <section className="grid">
      ...
      <button onClick={debugDates} className="hidden">Debug Dates</button>
