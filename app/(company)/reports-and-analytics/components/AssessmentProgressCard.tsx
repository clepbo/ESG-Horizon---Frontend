    ...
    const sections = [
      {
        ...
        keys: ["electricityHeat", "industrialProcesses", "oilGasOperations"] as const,
      },
      {
        name: "Mobile Sources",
        keys: ["roadTransport", "vehicleEquipment", "marineAviation"] as const,
      },
      {
      ...
      },
      {
        ...
        keys: ["methaneLeaks", "ventingNaturalGas", "incompleteCombustion", "hfcLeaks"] as const,
      },
    ];
