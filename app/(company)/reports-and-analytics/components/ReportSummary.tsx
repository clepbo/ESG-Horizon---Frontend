      ...
      <div className="max-w-7xl mx-auto space-y-6" id="section">
          ...
          <CardContent className="p-6 lg:p-8">
            ...
            <div className="grid grid-flow-col auto-cols-auto items-start gap-4">
              ...
              <div className="space-y-2 ">
                ...
                <div className="">
                  <div
                    className={`inline-flex items-center px-2 py-0.5 rounded-full bg-orange-500 text-white text-xs font-medium`}
                  >
                    {props.status}
                  </div>
              ...
              {/* Actions */}
              <div
                className="flex flex-col sm:flex-row gap-2 lg:justify-end no-export"
                id="hide1"
              >
        ...
        <Tabs defaultValue="all" className="w-full no-export">
          ...
          <TabsContent value="environment">
            {" "}
            <PillarAssessmentCard heading="Environmental" data={data} />{" "}
          </TabsContent>
          <TabsContent value="social">
            {" "}
            <PillarAssessmentCard heading="Social" data={data} />{" "}
          </TabsContent>
          <TabsContent value="governance">
            {" "}
            <PillarAssessmentCard heading="Governance" data={data} />{" "}
          </TabsContent>
        </Tabs>
