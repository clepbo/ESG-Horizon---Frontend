...
export default function AssessmentEnvironmental({ reportData }: AssessmentAllProps) {
    ...
    <div className="w-full">
      <Card className="bg-white border-0 shadow-sm w-full">
        <CardContent className="p-6 lg:p-8">
          <h2 className="text-xl lg:text-2xl font-semibold text-foreground mb-6">Environmental</h2>
                  ...
                  <div className="space-y-1">
                    <p className="text-2xl font-semibold">
                      {index === 0
                        ...
                        : formatNumberFigures(item.value)}
                    </p>
