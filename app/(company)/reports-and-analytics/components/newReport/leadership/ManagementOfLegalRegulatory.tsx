    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <Card className="rounded-lg shadow-sm border-0 grid gap-3 overflow-hidden">
        ...
        <div className="bg-[#fafafa] m-4 rounded-md p-4 items-center flex justify-between">
          ...
          <span
            className={`rounded-2xl px-2 py-1 ${legalData?.publicPolicyAndLobbying === "yes" ? "bg-success-200 text-[#388e4e]" : "bg-gray-100 text-gray-700"}`}
          >
      ...
      <Card className="rounded-lg shadow-sm border-0 grid gap-3 overflow-hidden">
        ...
        <div className="bg-[#fafafa] m-4 rounded-md p-4 items-center flex justify-between">
          ...
          <span
            className={`rounded-2xl px-2 py-1 ${legalData?.hasBoardCommittee === "yes" ? "bg-success-200 text-[#388e4e]" : "bg-gray-100 text-gray-700"}`}
          >
