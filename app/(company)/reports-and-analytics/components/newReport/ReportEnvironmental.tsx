...
import EmissionsByScope from "./environmental/EmissionByScope";
    ...
    <div className="flex flex-col gap-4 lg:gap-20">
      <div className="grid gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
          <EmissionsChart borderColor="#1e8a3d" bgColor="#dff9e6" color="#84bb94" />
          <EmissionsChart borderColor="#2570eb" bgColor="#dff9e6" color="#84bb94" />
          <EmissionsChart borderColor="#fac565" bgColor="#dff9e6" color="#84bb94" />
          <EmissionsChart borderColor="#af57db" bgColor="#dff9e6" color="#84bb94" />
        </div>
          ...
          <div className="rounded-2xl shadow gap-2 flex flex-col">
            ...
            <div className="p-4 flex flex-col my-20 w-full gap-6 h-full">
              <div className="flex flex-col items-center justify-center text-sm">
                ...
                <p className="font-semibold text-3xl ml-4">7</p>
              </div>
            ...
            <div className="flex items-center justify-between align-middle h-full p-4">
              <div className="flex flex-col items-center gap-2 text-xs">
                ...
                <span className="font-semibold text-2xl">0bbl </span>
              </div>
              <div className="flex flex-col items-center gap-2 text-xs">
                <span className="font-thin"> Sensitive Shorelines </span>
                <span className="font-semibold text-[#d48c3b] text-2xl">45bbl </span>
              </div>
            </div>
          </div>
          <div className="rounded-2xl shadow gap-2 flex flex-col">
