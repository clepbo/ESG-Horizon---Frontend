    ...
    <>
      <aside className="hidden lg:flex h-screen bg-white border-r border-gray-100 flex-col transition-all duration-300 w-[270px] flex-shrink-0">
        <div className="p-4 border-b border-gray-100">
          ...
          <div className="mb-1 flex items-center space-x-2 bg-teal-600 rounded-md px-3 py-2">
            <Image
        ...
        <div className="flex-grow p-4 overflow-y-auto mt-0">
          <nav className="space-y-1">
            ...
            >
              <Link
                href="/dashboard-esg"
                className={clsx(
                  "w-full flex items-center justify-start rounded-md transition-all duration-300 ease-in-out px-4 py-2",
            ...
            >
              <button
                ...
                className={clsx(
                  "w-full flex items-center justify-start rounded-md transition-all duration-300 ease-in-out px-4 py-2 cursor-pointer",
              ...
              return (
                ...
                >
                  <Link
                    ...
                    className={clsx(
                      "w-full flex items-center justify-start rounded-md transition-all duration-300 ease-in-out px-4 py-2",
                      isActive ? "bg-teal-600 text-white" : "text-teal-900 hover:bg-teal-50"
                    )}
                  >
                    <Icon
                      className={clsx(
        ...
        <div className="px-4 pb-4 border-t border-gray-100">
          <button
            ...
            className="flex items-center justify-start text-sm font-medium text-red-600 hover:underline cursor-pointer py-2"
          >
