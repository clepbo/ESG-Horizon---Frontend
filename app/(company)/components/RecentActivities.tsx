...
import { CheckCircle, XCircle, ArrowUpCircle, Clock, Ban, ActivitySquare } from "lucide-react";
...
export default function RecentActivities({ activities = [] }: RecentActivitiesProps) {
  ...
  return (
    <div className="h-full flex flex-col">
      <h2 className="text-lg font-semibold text-gray-900 mb-2">Recent Activities</h2>
