...
export default function ReportTable() {
  ...
  }, [reportData, search, typeFilter, statusFilter]);
      ...
      <div className="flex flex-col md:flex-row justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <SelectFilter
            ...
            options={["All Status", "Published", "Approved", "Under Review", "Rejected", "Draft"]}
          />
        </div>
      </div>
      ...
      <div className="relative overflow-x-auto bg-white shadow rounded-xl">
        ...
        {paginatedReports.length === 0 && !loading ? (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            <div className="p-4 rounded-full bg-green-200 mb-4">
              <FileText className="w-5 h-5 text-green-600" />
            </div>
            <h3 className="text-lg font-semibold text-gray-800">No Reports Found</h3>
            <p className="text-sm text-gray-500 mt-1 max-w-md">
              You haven’t generated any ESG reports yet. Once you complete an assessment, your
              published or draft reports will appear here.
            </p>
          </div>
        ) : (
