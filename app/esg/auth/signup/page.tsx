...
export default function Index() {
    ...
    const [personalData, setPersonalData] = useState<SignupFormData | null>(
        null
    );
            ...
            <div className="min-h-screen flex flex-col lg:flex-row font-poppins">
                    ...
                    <div className="relative z-20 flex flex-col justify-start items-start px-10">
                        ...
                        <div className="text-white">
                            ...
                            <p className="text-base text-white/90 max-w-md">
                                Make your ESG data work for you. Track, manage,
                                and showcase your environmental, social, and
                                governance impact — all in one place.
                            </p>
                        </div>
                        <div className="mt-12">
                            <SecuritySlider />
                ...
                <div className="flex flex-1 items-center justify-center px-6 py-12 md:px-12 bg-white">
                    <div className="w-full max-w-lg space-y-6">
                        {currentStep === "signup" ? (
                            <SignupForm onNext={handlePersonalNext} />
                        ) : (
                            <OrganizationDetails
