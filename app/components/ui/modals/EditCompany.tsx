...
// import Select from "react-select"; // Using react-select as in the example
...
// import { Industry, industriesService } from "@/services/industries.services";
// import { FormField } from "../reusables/FormFields"; // Assumed path for a reusable FormField component
...
//       // company.id is not in the form data, so we need to add it manually to the payload
//       id: company.id,
//     };
//     updateCompany(
...
//           toast.info("Company profile updated successfully!");
//           onClose();
//           // Pass the updated company data to the onUpdate function
//           onUpdate({
//             ...company,
//             ...data,
//             company_logo_url: companyLogo || data.company_logo_url,
