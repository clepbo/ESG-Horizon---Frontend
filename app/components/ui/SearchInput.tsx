...
=======
      <button className="cursor-pointer absolute right-1 top-1/2 -translate-y-1/2 flex items-center gap-1 rounded-md bg-[var(--color-green-500)] px-3 py-1.5 text-xs text-neutral-50 hover:bg-opacity-90">
>>>>>>> 652ae645a3b9acce8466354cac416879387c8a5e
