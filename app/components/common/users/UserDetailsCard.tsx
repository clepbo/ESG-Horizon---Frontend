    ...
    <div className="space-y-6">
      ...
      <section className="rounded-xl border border-gray-200 shadow p-4 md:p-6 bg-white flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900">{user.first_name}</h2>
      ...
      {/* Personal Info */}
      <SectionCard title="Personal Information" onEdit={openModal} icon="/images/image.png">
        <InfoGrid
          items={[
      ...
      {/* Company Info */}
      <SectionCard title="Company Information" onEdit={openModal} icon={"/images/image2.png"}>
        <InfoGrid
          items={[
    ...
    <section className="rounded-xl border border-gray-200 shadow bg-white p-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3 font-semibold text-gray-900 text-base">
          <Image src={icon} alt={`${title} Icon`} width={28} height={28} className="rounded-full" />
          {title}
        </div>
        <button
          onClick={onEdit}
