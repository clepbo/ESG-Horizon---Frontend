                  ...
                  <div className="bg-blue-50 rounded-lg p-5 mb-4">
                    ...
                    {assessmentData.stationarySources.electricityHeat && (
                      <div className="bg-white rounded p-4 mb-3">
                        ...
                        {assessmentData.stationarySources.electricityHeat.dieselGenerators &&
                          assessmentData.stationarySources.electricityHeat.dieselGenerators.length >
                            0 && (
                      ...
                      <div className="bg-white rounded p-4 mb-3">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          <div>
                            ...
                            <span className="ml-2 font-semibold">
                              {countItems(assessmentData.mobileSources.roadTransport.vehicleFleet)}{" "}
                              entries
                            </span>
                          </div>
                          <div>
                      ...
                      <div className="bg-white rounded p-4">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          <div>
                            ...
                            <span className="ml-2 font-semibold">
                              {countItems(assessmentData.mobileSources.marineAviation.air)} entries
                            </span>
                          </div>
                          <div>
