...
export default function WaterAndWastemanagamentCards({ backToAssessmentHub, backToDisclosureTopics }: AirQualityProps) {
                    ...
                    <Card className="w-full p-6 flex min-h-[90vh] flex-col gap-3 lg:gap-6 bg-white rounded-md shadow-md">
                        <div className="flex flex-col gap-3 md:flex-row items-center w-full md:justify-between">
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-sm">
                                    This disclosure topic quantifies the company's water footprint, from freshwater withdrawal to the management and disposal of operational wastewater, to assess overall resource efficiency and environmental impact. It metric  IFRS codes: EM-EP-140a.1, EM-EP-140a.2, EM-EP-140a.3 and EM-EP-140a.4
                                </p>
                            </div>
                        ...
                        <div>
                            ...
                            <h5> Water and Produced Water Management <CustomTooltip detail={<TooltipMessage title={'Water and Produced Water Management'}
                                message={"Report how your company manages freshwater use and wastewater generated during operations.This includes tracking water withdrawal, treatment, discharge, recycling, and measures taken to reduce environmental impacts such as contamination or excessive water consumption."} />
                            } />
                            </h5>
                        ...
                        <div>
                            ...
                            <h5>  Hydraulic Fracturing Impacts <CustomTooltip detail={<TooltipMessage title={'Hydraulic Fracturing Impacts'}
                                message={"Disclose how hydraulic fracturing (fracking) activities affect local water systems.This includes chemical usage, wastewater handling, spill prevention, groundwater protection measures, and comparison of water quality before and after drilling activities."} />
                            } />
                            </h5>
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
