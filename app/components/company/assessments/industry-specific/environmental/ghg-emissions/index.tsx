...
const scopeData = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        subtitle:
          "Emissions from moving equiment or vehincles, such as trucks, ships, or planes",
        clickable: true,
      },
      {
        title: "Process Emissions",
        subtitle:
          "Emissions released during industrial processes, not related to fuel combustion",
        clickable: true,
      },
      {
        title: "Fugitive Emissions",
        subtitle:
          "Unintentional leaks of gases from equipment, pipelines, or storage",
        clickable: true,
      },
    ],
  },
        ...
        <Card className="bg-gray-50">
          <CardContent className="p-6">
            <div className="flex items-center gap-2 border border-blue-300 bg-blue-50 rounded-md px-3 py-2 mb-4">
              ...
              <p className="text-sm">
                In your first year, Scope 3 reporting is optional. You may keep
                your current GHG calculation method.
              </p>
            </div>
            <div className="flex items-center justify-between mt-5 mb-8">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-md">
                  Total emissions from Subsidiaries and supply chains, measured
                  in CO2-equivalent
                </p>
              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {scope.cards.map((card) => (
                        <Card
                          ...
                          onClick={() =>
                            card.clickable && handleCardClick(card.title)
                          }
                        >
