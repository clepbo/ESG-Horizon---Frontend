...
//     if (!debouncedSearchTerm) return scopes;

//     const searchLower = debouncedSearchTerm.toLowerCase();

//     return scopes
//       .map((scope) => {
//         const scopeMatches = scope.title.toLowerCase().includes(searchLower);
...
//                                   </h6>
//                                   <p>
//                                     Emissions from purchased elelctricity, steam, heating, or
//                                     cooling that your company consumes.
//                                   </p>
//                                 </>
//                               )}
