...
const uploadFields = [
  "Waste management statistics (national/regional reports)",
  "Recycling/disposal contracts",
...
export function EndOfLifeTreatment({
  onBack,
  onNext,
  stepIndex,
  totalSteps,
          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                {selectedMethods.others && (
                  <div className="ml-4 mt-4">
                    <SmartInput
                      label="Specify other disposal method"
                      placeholder="Enter other disposal method"
                      type="text"
                      required={selectedMethods.others}
                      value={otherDisposalMethod}
                      onChange={handleOtherDisposalMethodChange}
                      errorTrigger={fieldErrors.otherDisposalMethod}
                      errorMessage="Please specify the other disposal method."
                    />
                    {errors.otherDisposalMethod && (
