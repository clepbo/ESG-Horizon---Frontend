...
export function VentingNaturalGas({
  ...
  useEffect(() => {
    if (ventingNaturalGas) {
      volumeOfGasVented.setRawValue(
        ventingNaturalGas.volumeOfGasVented !== null &&
          ventingNaturalGas.volumeOfGasVented !== undefined
          ? ventingNaturalGas.volumeOfGasVented.toString()
          : ""
      );
  ...
  const { filled, total } = useMemo(() => {
    const hasVolume =
      ...
      volumeOfGasVented.rawValue !== null &&
  ...
  const validateForm = () => {
    ...
    if (
      ...
      newErrors.volumeOfGasVented = "Please enter a valid volume (0 or greater)";
    }
    setErrors(newErrors);
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        ...
                        <p className="text-xs">
                          Enter the total volume of gas vented during the reporting period.
                        </p>
                        <p className="text-xs mt-1">• You can enter 0 if no gas was vented</p>
