...
export function MethaneNitrousOxide({
  ...
  const { filled, total } = useMemo(() => {
    const isAnimalCountFilled = Object.values(animals).some((val) => val > 0);
    const isManureSystemSelected = selectedManureSystem !== "";
    const areFilesUploaded = Object.values(files).every(Boolean);

    const progressChecks = [
      isAnimalCountFilled,
      isManureSystemSelected,
      areFilesUploaded,
    ];

    return calculateProgress(progressChecks);
  }, [animals, selectedManureSystem, files]);
        ...
        <Card className="animate-in slide-in-from-bottom-4 duration-500 bg-gray-50 mt-6 mb-8 pt-6">
          <CardContent className="space-y-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-base">
                Emissions from manure management on large-scale poultry or
                livestock farms.
              </p>
            </div>
            ...
            >
              ...
              <div>
                ...
                {errors.animals && (
                  <p className="text-sm text-red-500 mb-2">{errors.animals}</p>
                )}
                    ...
                    <div key={type} className="flex flex-col">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          value={animals[type]}
                          onChange={(e) =>
                            handleAnimalChange(type, e.target.value)
                          }
                          className={`${inputClass} pr-16 ${
                            errors.animals ? "border-red-500" : ""
                          }`}
                        />
                        {(type === "Pigs" ||
              ...
              <div>
                <Label className="text-md font-medium mb-4 block">
                  Type of manure management system used (e.g., liquid slurry,
                ...
                <div className="space-y-2 ml-6">
                  {manureSystems.map((system) => (
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={selectedManureSystem === system.value}
                        onChange={() => handleManureSystemChange(system.value)}
                  ...
                  <label className="flex items-start space-x-3 py-2">
                    <input
                      type="checkbox"
                      checked={selectedManureSystem === "Others"}
                      onChange={() => handleManureSystemChange("Others")}
                      className="mt-1 w-4 h-4 text-green-600 bg-gray-100 border-gray-300 rounded focus:ring-green-500 focus:ring-2"
                    />
                    <div className="flex flex-col">
                      <span className="text-sm font-medium text-gray-900">
                  ...
                  {selectedManureSystem === "Others" && (
                    <div className="ml-7 mt-2">
                      <Input
                        ...
                        onChange={(e) => setOtherManureSystem(e.target.value)}
                        className={`w-full max-w-md ${
                          errors.otherManureSystem ? "border-red-500" : ""
                        }`}
                      />
              ...
              <div>
                ...
                <div className="ml-6">
                  {errors.files && (
                    <p className="text-sm text-red-500 mb-4">{errors.files}</p>
                  )}
