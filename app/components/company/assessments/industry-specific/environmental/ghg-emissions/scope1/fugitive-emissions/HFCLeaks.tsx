        ...
        <div className="flex items-center gap-6 mb-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-base">
              Unplanned releases of gases from equipment, pipelines, storage
              tanks, or processes, including methane leaks, gas venting, flaring
              inefficiencies, and refrigerant losses.
            </p>
          </div>
        </div>
        ...
        <Card className="animate-in slide-in-from-bottom duration-500 bg-gray-50 pt-6 pb-8">
          <CardContent className="space-y-8">
            ...
            <h2 className="text-lg font-semibold text-gray-800">
              1.1 Leaks of HFCs from Cooling and Air Conditioning Units
            </h2>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col w-full">
                  <Label htmlFor="refrigerantAdded" className={labelClass}>
                    Quantity of Refrigerant Added (Kilograms)
                  </Label>
                  <Input
                    id="refrigerantAdded"
                    ...
                    onChange={handleChange}
                    className={`w-full ${
                      errors.refrigerantAdded ? "border-red-500" : ""
                    }`}
                  />
