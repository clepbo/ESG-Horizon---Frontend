...
export function HFCLeaks({
    ...
    const handleSubmit = () => {
        ...
        const payload = {
            ...
            R407C: formState.R407C,
            R507A: formState.R507A,
            others: isNaN(Number(formState.others))
                ? 0
                : Number(formState.others),
            refrigerantAdded: Number(formState.refrigerantAdded),
            files: files,
            additionalFields: additionalFields as FileMetadata[],
        };
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex items-center gap-6 mb-4">
                    <Button
                        variant="outline"
                        onClick={onBack}
                        className="flex items-center gap-2 bg-white border-teal-600 text-teal-700 hover:bg-green-50"
                ...
                <Card className="animate-in slide-in-from-bottom duration-500 bg-gray-50 pt-6 pb-8">
                    <CardContent className="space-y-8">
                        ...
                        <h2 className="text-lg font-semibold text-gray-800">
                            2.1 Leaks of HFCs from Cooling and Air Conditioning
                            Units
                        </h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2">
                                <Label className={labelClass}>
                                    Types of hydrofluorocarbons (HFCs) used.
                                </Label>
