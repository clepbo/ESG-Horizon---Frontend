...
export function RoadTransport({
    ...
    const vehicleFleetOptions = useMemo(
        () => getFuelOptions("vehicleFleet"),
        []
    );
    ...
    useEffect(() => {
        ...
        if (existingData) {
            setVehicleFleet(
                existingData.vehicleFleet ||
                    getInitialSources([], vehicleFleetOptions)
            );
            setCarsBuses(
                existingData.carsBuses ||
                    getInitialSources([], carsBusesOptions)
            );
            setFiles(
                existingData.files ||
                    Object.fromEntries(
    ...
    const handleSaveAndContinue = () => {
        ...
        dispatch({ type: "UPDATE_MOBILE_ROAD_TRANSPORT", payload });
