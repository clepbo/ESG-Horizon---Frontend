...
export function RoadTransport({
    ...
    useEffect(() => {
        ...
        >["roadTransport"];
        if (existingData) {
            setDieselTruckFuelType(
                existingData.dieselTruckFuelType ?? "Diesel"
            );
            setDieselTruckVolume(
                existingData.dieselTruckVolume?.toString() ?? ""
            );
            setCarFuelTypes({
                Petrol: !!existingData.carPetrolVolume,
                Diesel: !!existingData.carDieselVolume,
    ...
    const validateForm = () => {
        ...
        if (!dieselTruckFuelType) {
            newErrors.dieselTruckFuelType =
                "Please select a fuel type for trucks";
        }
        if (!dieselTruckVolume) {
            newErrors.dieselTruckVolume =
                "Please enter the diesel volume for trucks";
        } else if (
                ...
                <Card className="animate-in slide-in-from-bottom-4 duration-500 bg-gray-50 mt-6 mb-8 pt-6">
                    <CardContent className="space-y-8">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-base">
                                Emissions from moving equipment or vehicles,
                                such as trucks.
                            </p>
                        </div>
                        ...
                        <div>
                            <Label className="text-md font-semibold mb-2 block">
                                1.1 Fleet of Diesel Trucks for Product
                        ...
                        <div>
                            <Label className="text-md font-semibold mb-2 block">
                                1.2 Company Cars and Buses Used for Employee
                                Transportation
                            </Label>
                            <div className="space-y-4 ml-6">
                                <Label>Type of Fuel</Label>
