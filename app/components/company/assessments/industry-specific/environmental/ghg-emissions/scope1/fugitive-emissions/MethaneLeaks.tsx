...
export function MethaneLeaks({
  ...
  const methaneLeaksData = state.assessmentData.fugitiveEmissions?.methaneLeaks;
  ...
  useEffect(() => {
    if (methaneLeaksData) {
      ...
      setMethanePercent(methaneLeaksData.methanePercent?.toString() ?? "");
      setFiles(
        ...
        <div className="flex items-center gap-6 mb-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-base">
              Methane leaks from pipelines, valves, connectors, and storage
              tanks.
            </p>
          </div>
        </div>
        ...
        <Card className="animate-in slide-in-from-bottom-4 duration-500 bg-gray-50 mt-6 mb-8 pt-6">
          <CardContent className="space-y-8">
            ...
            <Label className="text-xl font-medium mb-4">
              1.1 Methane Leaks from Pipelines, Valves, Connectors, and Storage
              Tanks
            </Label>
            ...
            <div className="ml-6 grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-6">
              {numericErrorKeys.map((errorKey) => {
                if (errorKey === "others") {
                  return (
                    <div key={errorKey} className="col-span-full flex flex-col">
                      <Label className="text-sm font-medium mb-2">Others</Label>
                      <Input
                        type="number"
                        min={0}
                        step="any"
                        value={others}
                        onChange={handleInputChange(setOthers, "others")}
                        className={
                          errors.others
                ...
                const labelMap: Record<ErrorKeys, string> = {
                  compressors: "Compressors (centrifugal, reciprocating)",
                ...
                return (
                  <div key={errorKey} className="flex flex-col">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange(setMap[errorKey], errorKey)}
                      className={
                        errors[errorKey]
                          ? "border-red-500 focus:border-red-500"
                          : ""
                      ...
                      aria-describedby={
                        errors[errorKey] ? `${errorKey}-error` : undefined
                      }
                    />
                    {errors[errorKey] && (
                      <p
              ...
              <div className="col-span-full flex flex-col">
                ...
                <Input
                  ...
                  aria-describedby={
                    errors.methanePercent ? "methanePercent-error" : undefined
                  }
                />
                {errors.methanePercent && (
                  <p
                ...
                <p className="text-xs text-gray-600 mt-1">
                  Specify the percentage of methane in the leaked gas.
                </p>
              </div>
            </div>
            ...
            {errors.files && (
              <p className="text-red-600 text-sm mb-4">{errors.files}</p>
            )}
