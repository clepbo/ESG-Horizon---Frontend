...
export function IndustrialProcessesForm({
    ...
    const handleSaveAndContinue = async () => {
        ...
        await saveAssessment(state.assessmentData, {
            onSuccess: () => {
                onBackToHub();
            },
        });
                ...
                <Card className="animate-in slide-in-from-bottom-4 duration-500 bg-gray-50 mt-6 mb-8 pt-6">
                    <CardContent className="space-y-8">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-base">
                                Emissions from manufacturing activities such as
                                boilers and furnaces, based on the type and
                                amount of fuel used.
                            </p>
                        </div>
...
//               </h4>
//               <p className="text-muted-foreground text-base">
//                 Emissions from manufacturing activities such as boilers and
//                 furnaces, based on the type and amount of fuel used.
//               </p>
//             </div>
