                ...
                <div className="flex items-center gap-6 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-base">
                            Emissions from cooling energy purchased for your
                            facilities
                        </p>
                    </div>
                </div>
                    ...
                    <CardContent className="space-y-8">
                        ...
                        <div>
                            ...
                            <div className="space-y-4 ml-6">
                                <Label>
                                    Amount of Energy Cooling Energy Consumed
                                    (kWh)
                                </Label>
                                <Input
                                    id="cooling-consumed"
                                    ...
                                    onChange={(e) =>
                                        setCoolingConsumed(e.target.value)
                                    }
...
//   { id: "centralized", label: "Centralized Chiller Plant (building-based)" },
//   { id: "direct", label: "District Cooling System (utility-purchased)" },
//   { id: "packaged", label: "Packaged Air Conditioning Units (split/rooftop)" },
//   { id: "portable", label: "Portable Cooling Systems" },
//   { id: "evaporative", label: "Evaporative Cooling Systems" },
// ];
