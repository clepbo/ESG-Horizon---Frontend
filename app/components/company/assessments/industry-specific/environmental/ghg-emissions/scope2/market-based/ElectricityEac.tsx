                ...
                <div className="flex items-center gap-6 mb-4">
                    ...
                    <div>
                        <h3 className="text-2xl font-semibold text-foreground">
                            Purchased Electricity with Energy Attribute
                            Certificates (Scope 2 – Market Based)
                        </h3>
                        <p className="text-muted-foreground text-base">
                            Report grid electricity consumption backed by Energy
                            Attribute Certificates (EACs/RECs) and
                    ...
                    <CardContent className="space-y-8">
                        ...
                        <div>
                            <Label className="text-base font-medium text-gray-900 mb-2 block">
                                2.1 Purchased Electricity (with Energy Attribute
                            ...
                            <Card className="p-4 flex flex-col items-center justify-center border-2">
                                ...
                                >
                                    ...
                                    <span className="text-xs text-gray-400 text-center">
                                        Attach Energy Attribute Certificate or
                                        Renewable Energy Certificate proving
