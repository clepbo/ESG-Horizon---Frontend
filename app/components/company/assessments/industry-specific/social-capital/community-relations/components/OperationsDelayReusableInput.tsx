...
export default function OperationsDelayReusableInput({ 
    ...
    return (
        <div className='space-y-2'>
            ...
            <div className={`grid grid-cols-3 bg-gray-100 rounded-md p-3 gap-3 border ${shouldDisplayError ? 'border-red-300' : 'border-gray-200'} focus-within:border-blue-500 focus-within:bg-blue-50 transition-colors`}>
                <Input 
