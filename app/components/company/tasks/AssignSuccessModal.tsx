...
export function AssignSuccessModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent style={{ maxWidth: "850px", width: "100%" }} className="p-10 rounded-2xl">
        <DialogTitle className="sr-only">Task Assigned Successfully!</DialogTitle>
