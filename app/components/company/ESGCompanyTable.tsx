...
export default function ESGCompanyTable({ companies }: CompanyTableProps) {
    ...
    const [targetStatus, setTargetStatus] = useState<Company["status"] | null>(
        null
    );
    ...
    return (
        <div className="relative overflow-x-auto bg-white shadow rounded-xl">
                            ...
                            <td className="px-4 py-3 flex space-x-2">
                                ...
                                {statusActions[company.status] && (
                                    <button
                                        ...
                                        title={
                                            statusActions[company.status].title
                                        }
                                        onClick={() =>
                                            openModal(
                                                company.id,
            ...
            <ConfirmModal
                ...
                message={
                    <span>
                        Are you sure you want to change this company&apos;s
                        status to <strong>{targetStatus}</strong>?
                    </span>
                }
