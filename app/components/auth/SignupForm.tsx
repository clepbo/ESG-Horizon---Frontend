...
export const SignupForm = ({ onSubmitted }: { onSubmitted: () => void }) => {
  ...
  return (
    <div className="w-full max-w-lg space-y-6">
      <h2 className="text-2xl font-bold text-neutral-1000">Let&apos;s get started</h2>
          ...
          <Controller
            ...
            render={({ field }) => {
              const selectedOption =
                industryOptions.find((opt) => opt.value === field.value) || null;
              return (
                <div className="flex flex-col">
                  <label className="block text-sm font-medium text-neutral-1000">Industry</label>
                  <Select
