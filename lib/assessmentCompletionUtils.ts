...
function checkMultiComponentCompletion(
  ...
  console.log("🔍 Checking multi-component topic:");
  console.log("  Sub-component paths:", subComponentPaths);
  ...
  subComponentPaths.forEach((componentPath) => {
    ...
    if (componentData && hasActualData(componentData)) {
      ...
      console.log(
        `  ${componentPath}:`,
        componentCompletion.status,
        `(${componentCompletion.completionPercentage}%)`
      );
      ...
      console.log(`  ${componentPath}: NO DATA`);
    }
  });

  console.log(`\n📊 Summary:`);
  console.log(`  Total components: ${subComponentPaths.length}`);
  console.log(`  Components with data: ${componentsWithData}`);
  console.log(`  Completed components: ${completedComponents}`);
  console.log(`  Partial components: ${partialComponents}`);
  ...
  console.log(`✅ Final status: ${status} (${completionPercentage}%)\n`);
